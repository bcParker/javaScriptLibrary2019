...
//  1) they take some input that the function will handle or process
//  2) the process the input given to them
//  3) they usually, but not always, return some value
//  4) they can be invoked(used) as many times as we want, cuttin down on code repetition
...
console.log(sentence('Chase', 'Parker'));

let superImportantSentence = sentence('Nicky', 'Disborough');
console.log(superImportantSentence);

//lets build a function that takes a complex type, an array in this case and console.logs each item in the input array
